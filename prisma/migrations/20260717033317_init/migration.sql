...
CREATE TYPE app_user.user_role AS ENUM ('alumno', 'entrenador', 'admin');
...
ALTER TABLE entrenador.entrenador
  ...
  FOREIGN KEY (id_plan) REFERENCES app_user.plan (id) DEFERRABLE INITIALLY IMMEDIATE;
