...
CREATE TABLE entrenador.entrenador_plan (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY NOT NULL,
  cantidad_alumno INT NOT NULL,
  nombre VARCHAR(50) NOT NULL,
...
CREATE TABLE entrenador.entrenador (
  ...
  id_plan BIGINT NOT NULL DEFAULT 1,
...
ALTER TABLE entrenador.entrenador
  ...
  FOREIGN KEY (id_plan) REFERENCES entrenador.entrenador_plan (id) DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE alumno.alumno
